     ...
     out.print("<table class='table'>");
	    ...
	    for(int i=0;i<u.list.size();i++){
	    	 out.print("<tr>"+
	    	           ...
	    	           "<td><input name="+'"'+u.list.get(i).id+'"'+" class='mdata' value="+'"'+u.list.get(i).name+'"'+"></td>"+
	    			   ...
	    			   "<td>"+
	    			   "<button onclick='change(this)' class='button button-primary button-square button-small' value="+'"'+u.list.get(i).id+'"'+">+</button> <button class='button button-primary button-square button-small' onclick='del(this)' value="+'"'+u.list.get(i).id+'"'+">-</button></td>"+
	    			   "</tr>");
	    	 }
	    out.print("</table>");
  %>
    ...
    <script>
     function change(index){
  	   ...
  	   $.ajax({
		   ...
		   success:function(){{alert("已修改");location.href=('manageinfo.jsp');}
		    },
		   dataType:"text"
	   });
     }}
     function del(index){
    	 ...
    	 var info=document.getElementsByName(index.value);
    	   $.ajax({
    		   ...
    		   success:function(){{alert("已删除");location.href=('manageinfo.jsp');}
    		    },
    		   dataType:"text"
    	   });
     }}
